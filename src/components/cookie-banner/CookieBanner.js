...
const CookieBanner = ({ ...remainingProps }) => {
  ...
  return (
    <WrapperDiv {...remainingProps}>
      <div>
        <p>
          This site uses first and third party cookies to provide you with a
          great user experience. By using this site you accept our use of
          cookies. For more details about cookies and how to manage them, see
          our Cookie Policy.
        </p>
